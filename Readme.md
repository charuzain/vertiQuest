...
:hover: used to apply styles when the mouse cursor moves over the link
...
context : tell us where we are within in the object
this ->. window object
console.log(this) === window // true
this -> what is the object environment we are in

instantitaion : when we make multiple copies(instance) of an object anduse it